    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            Innovative optimized solution seeker. Excited to be at the development phase of my new career as web developer. 
      ...
      <div className="i-right">
        ...
        >
          <FloatinDiv img={developer} text1="Web" text2="Developer" />
        </motion.div>
        ...
        >
          ...
          <FloatinDiv img={award} text1="Best Design" text2="Award" />
        </motion.div>
